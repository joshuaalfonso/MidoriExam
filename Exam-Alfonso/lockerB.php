...
<head>
    ...
    <link rel="stylesheet" href="locker.css?v3">
</head>
<style>
   h1{
    text-align:center;
    ...
    <section>
        ...
        <div class="top">
            <div class="lockers">
                ...
                <a href="lockerB.php"><button class="locker active">Locker B</button></a>
                <a href="lockerC.php"><button class="locker">Locker C</button></a>
            </div>
            <div class="total">        
